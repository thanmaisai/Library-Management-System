...
#user input data for login/register 
def gettingDetails():
    Id = ent1.get()
    name = ent2.get()
    password = ent3.get()
...
def Menu():
    ...
    btn1 = Button(moduleFrame,text="Add Book Details",bg="light green",font=("arial",12,'bold'),compound = LEFT, command=addBooks, state=state1)
    btn1.place(relx=0,rely=0.17, relwidth=1,relheight=0.12)
    
    btn2 = Button(moduleFrame,text="Delete Book",bg="light green",font=("arial",12,'bold'), compound= LEFT, command=delete,state=state1)
    btn2.place(relx=0,rely=0.31, relwidth=1,relheight=0.12)
    
    btn3 = Button(moduleFrame,text="View Book List",bg="light green",font=("arial",12,'bold'), compound= LEFT, command=View,state=state2)
    btn3.place(relx=0, rely=0.44, relwidth=1,relheight=0.12)
    
    btn4 = Button(moduleFrame,text="Search Book",bg="light green",font=("arial",12,'bold'),compound= LEFT, command=searchBook,state=state2)
    btn4.place(relx=0,rely=0.58, relwidth=1,relheight=0.12)
   
    btn5 = Button(moduleFrame,text="Issue Book to Student",bg="light green",font=("arial",12,'bold'), compound = LEFT, command = issueBook,state=state1)
    btn5.place(relx=0,rely=0.72, relwidth=1,relheight=0.12)
  
    btn6 = Button(moduleFrame, text="Return Book",font=("arial",12,'bold'),bg="light green",compound = LEFT, command=ReturnBook,state=state1)
    btn6.place(relx=0,rely=0.86, relwidth=1,relheight=0.12)

    logoutBtn=Button(headingFrame, text="LOGOUT",bg="red", font=('arial',10,'bold'), command=logout, state=state3)
...
################################## Frames #########################################################################
# top bar frame(login,register,logout)
headingFrame = Frame(root,bd=10, relief=RIDGE,bg="light blue")
headingFrame.place(relx=0,rely=0,relwidth=1,relheight=0.2)
heading=Label(headingFrame,font=('Times New ROman', 40, 'bold'), text="Library Management System",bg="light blue")
heading.place(relx=0, rely=0.2)

#menu bar frame
moduleFrame = Frame(root,bd=10, relief=RIDGE,bg="light blue")
moduleFrame.place(relx=0,rely=0.2,relwidth=0.2,relheight=0.8)
headingLabel = Label(moduleFrame, text="MENU",font=("Times New Roman",26,'bold'),bg="light blue")
headingLabel.place(relx=0,rely=0, relwidth=1, relheight=0.15)

#display frame(center display)
dFrame= Frame(root,bd=10, relief=RIDGE,bg="light blue")
...
#login button
loginBtn = Button(headingFrame,text="LOGIN",bg="green", font=("arial",10,'bold'),command=gettingLoginDetails)
loginBtn.place(relx=0.87,rely=0.4, relwidth=0.1)

#register button
regBtn=Button(headingFrame,text="REGISTER",bg="green", font=("arial",10,'bold'),command=gettingDetails)
